    ...
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->saveApiKeyButton, &QPushButton::clicked, this, &SettingsWidget::onSaveApiKeyClicked);
}
...
void SettingsWidget::onSaveApiKeyClicked()
{
    QString text = ui->apiKeyLineEdit->text();
    QSettings settings;
